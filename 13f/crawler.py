...
download_directory=r'/Users/captain/GitHub/kaist/DBregression/13f/datas'
since_year=1993
landing_pages=[]
edgar.download_index(download_directory, since_year, "mingu cola@kaist.ac.kr",skip_all_present_except_last=False)
...
combined_DF.to_csv(r"/Users/captain/GitHub/kaist/DBregression/13f/datas\13Foutput"+'/Berkshire_Hathaway_holdings.csv')
totalstock_DF.to_csv(r"/Users/captain/GitHub/kaist/DBregression/13f/datas\13Foutput"+'/Berkshire_Hathaway_shares.csv')